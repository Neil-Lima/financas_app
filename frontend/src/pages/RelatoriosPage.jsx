...
const RelatoriosPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(`https://financas-app-kappa.vercel.app/api/relatorios/completo?dataInicio=${dataInicial}&dataFim=${dataFinal}`, {
  ...
  const handleDownloadPDF = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.get(`https://financas-app-kappa.vercel.app/api/relatorios/pdf?dataInicio=${dataInicial}&dataFim=${dataFinal}`, {
        headers: { Authorization: `Bearer ${token}` },
        responseType: 'blob'
      });
