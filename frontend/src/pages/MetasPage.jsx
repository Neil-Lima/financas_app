...
const MetasPage = () => {
  ...
  const fetchMetas = async () => {
    try {
      ...
      const response = await axios.get('https://financas-app-kappa.vercel.app/api/metas', {
  ...
  const fetchEstatisticas = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.get('https://financas-app-kappa.vercel.app/api/metas/estatisticas', {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://financas-app-kappa.vercel.app/api/metas', metaData, {
        headers: { Authorization: `Bearer ${token}` }
      });
      setNewMeta({
        descricao: '',
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      await axios.put(`https://financas-app-kappa.vercel.app/api/metas/${editingId}`, metaData, {
        headers: { Authorization: `Bearer ${token}` }
      });
      setEditingId(null);
      fetchMetas();
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Tem certeza que deseja excluir esta meta?')) {
      try {
        const token = localStorage.getItem('token');
        await axios.delete(`https://financas-app-kappa.vercel.app/api/metas/${id}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
        fetchMetas();
